...
//--------------------------------------------------------------------------------------------------
  ...
  var handleEvents = function() { //запуск и отслеживание событие
    ...
    return {
      ...
      redraw: function() {/*handleEvents();*/engine.clean();for (var stage in stack) {requestAnimFrame(stack[stage]);}console.log(stack)},
      ...
      /**/
      earc: function(x,y,r,sA,eA,a){stack.push(ctx.arc(x,y,r,sA,eA,a));}
    };
  })(window, document);
  engine.init();
  engine.redraw();
